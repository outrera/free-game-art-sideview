Author: Tiny Speck (http://tinyspeck.com/)
License: CC0 (Public Domain)
Origin: https://www.glitchthegame.com/public-domain-game-art/
        https://github.com/tinyspeck


Glitch Locations
Glitch was a browser-based MMO created by Tiny Speck. This repository contains the artwork and source code for all of the locations in the game.
...
What is included:
- The source and artwork for all of the bits and pieces used to build streets (the source directory).
- All of those bits and pieces bundled up into the SWF files used by the game client (the glitch-location-swfs directory).
